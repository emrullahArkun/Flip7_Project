 ...
 */
public class DefaultProbabilityCalculator implements SuccessProbabilityCalculator {

    /**
     * @return Success probability (0.0 to 1.0) that the next HIT will NOT bust.
     */
    @Override
    public double calculateSuccessProbability(List<Card> playerHand, List<Card> remainingDeck) {
    ...
    private boolean hasSecondChance(List<Card> hand) {
        for (Card c : hand) {
    ...
    private double getBustProbability(List<Card> playerHand, List<Card> remainingDeck) {
